...
public class Tsder01  implements Serializable {
	 ...
	 * 岗位
	 */
	@ExcelProperty(value="所在岗位",index = 4,converter = JobsColdConverter.class)
	private String jobs;
	 ...
	 * 社保所在地
	 */
	@ExcelProperty(value="社保所在地",index = 9)
	private String secLocation;

	/**
	 * 社保信息
	 */
	@ExcelProperty(value="社保信息",index = 10)
	private String secInf;

	/**
	 * 属地化
	 */
	@ExcelProperty(value="属地化",index = 11)
	 ...
	 * 身份证号
	 */
	@ExcelProperty(value="身份证号",index = 15)
	private String idCard;

	/**
	 * 出生年月
	 */
	@ExcelProperty(value="出生年月",index = 16)
	 ...
	 * 华夏工资卡号
	 */
	@ExcelProperty(value="华夏工资卡号",index = 18)
	private String hxCardId;

	/**
	 * 工商银行卡号
	 */
	@ExcelProperty(value="工商银行卡号",index = 19)
	 ...
	 * 毕业学校
	 */
	@ExcelProperty(value="毕业学校",index = 23)
	private String universityName;

	/**
	 * 毕业时间
	 */
	@ExcelProperty(value="毕业时间",index = 24)
	private String graDate;

	/**
	 * 所学专业
	 */
	@ExcelProperty(value="所学专业",index = 25)
	 ...
	 * 紧急联系人
	 */
	@ExcelProperty(value="紧急联系人",index = 27)
	private String emeContact;

	/**
	 * 与紧急联系人关系
	 */
	@ExcelProperty(value="与紧急联系人关系",index = 28)
	private String emeRel;

	/**
	 * 紧急联系人电话
	 */
	@ExcelProperty(value="紧急联系人电话",index = 29)
	private String emeTel;

	/**
	 * 户籍地址
	 */
	@ExcelProperty(value="户籍地址",index = 30)
	private String thrAddress;

	/**
	 * 居住地址
	 */
	@ExcelProperty(value="居住地址",index = 31)
	private String resAddress;

	/**
	 * 入司时间
	 */
	@ExcelProperty(value="入司时间",index = 32)
	private String empDate;

	/**
	 * 司龄
	 */
	@ExcelProperty(value="司龄",index = 33)
	private String indYear;

	/**
	 * 合同签订时间
	 */
	@ExcelProperty(value="合同签订时间",index = 34)
	private String signDate;

	/**
	 * 合同到期时间
	 */
	@ExcelProperty(value="合同结束时间",index = 35)
	private String endDate;

	/**
	 * 最新结束时间
	 */
	@ExcelProperty(value="最新结束时间",index = 36)
	private String endDateNew;

	/**
	 * 合同到期提醒
	 */
	@ExcelProperty(value="合同到期提醒",index = 37)
	private String isRemindC;

	/**
	 * 试用期开始时间
	 */
	@ExcelProperty(value="试用期开始时间",index = 38)
	private String probStartDate;

	/**
	 * 试用期结束时间
	 */
	@ExcelProperty(value="试用期结束时间",index = 39)
	private String probEndDate;

	/**
	 * 试用期到期提醒
	 */
	@ExcelProperty(value="试用期到期提醒",index = 40)
