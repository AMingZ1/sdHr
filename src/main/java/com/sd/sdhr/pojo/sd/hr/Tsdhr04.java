...
public class Tsdhr04  implements Serializable {
	 ...
	 * 面试岗位
	 */
	@ExcelProperty(value="面试岗位",index = 3,converter = DeptColdConverter.class)
	private String itvJob;

	/**
	 * 面试时间
	 */
	@ExcelProperty(value="面试时间",index = 4)
	private String itvDate;

	/**
	 * 面试官
	 */
	@ExcelProperty(value="面试官",index = 5)
	private String itver;

	/**
	 * 面试方式
	 */
	@ExcelProperty(value="面试方式",index = 6,converter = OtherColdConverter.class)
	private String itvWays;

	/**
	 * 面试人员
	 */
	@ExcelProperty(value="面试人员",index = 7)
	private String memberName;

	/**
	 * 学校
	 */
	@ExcelProperty(value="学校",index = 8)
	private String universityName;

	/**
	 * 学历
	 */
	@ExcelProperty(value="学历",index = 9,converter = ExplevelColdConverter.class)
	 ...
	 * 成绩1
	 */
	@ExcelProperty(value="沟通、表达能力(20)",index = 13)
	 ...
	 * 成绩1
	 */
	@ExcelProperty(value="判断、分析、反应能力(10)",index = 14)
	 ...
	 * 成绩1
	 */
	@ExcelProperty(value="责任心、纪律性(10)",index = 15)
	 ...
	 * 成绩1
	 */
	@ExcelProperty(value="专业知识(30)",index = 16)
	 ...
	 * 成绩1
	 */
	@ExcelProperty(value="项目经验(15)",index = 17)
	 ...
	 * 成绩1
	 */
	@ExcelProperty(value="学习能力(15)",index = 18)
	 ...
	 * 总分
	 */
	@ExcelProperty(value="总分",index = 19)
	private int sumScore;

	/**
	 * 面试结果
	 */
	@ExcelProperty(value="面试结果",index = 20,converter = ContastatusColdConverter.class)
	private String itvStatus;

	/**
	 * 当前状态
	 */
	@ExcelProperty(value="当前状态",index = 21,converter = OtherColdConverter.class)
	private String nowStatus;

	/**
	 * 报道时间
	 */
	@ExcelProperty(value="人员编号",index = 22)
