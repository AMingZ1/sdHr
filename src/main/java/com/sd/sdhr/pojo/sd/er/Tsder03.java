...
public class Tsder03  implements Serializable {
	 ...
	 * 岗位
	 */
	@ExcelProperty(value="岗位",index = 4,converter = JobsColdConverter.class)
	private String jobs;
	 ...
	 * 周访谈日期
	 */
	@ExcelProperty(value="周访谈日期",index = 6)
	private String talkWeek;

	/**
	 * 月访谈日期
	 */
	@ExcelProperty(value="月访谈日期",index = 7)
	 ...
	 * 访谈状态
	 */
	@ExcelProperty(value="访谈状态",index = 9,converter = TalkstatusColdConverter.class)
	private String talkStatus;

	/**
	 * 最近访谈时间
	 */
	@ExcelProperty(value="最近访谈时间",index = 10)
	private String recTalkTime;

	/**
	 * 最近提醒访谈时间
	 */
	@ExcelProperty(value="最近提醒访谈时间",index = 11)
	private String remTalkTime;

	/**
	 * 入职时项目经理
	 */
	@ExcelProperty(value="入职时项目经理",index = 12)
	private String pmNameF;

	/**
	 * 入职时项目组信息
	 */
	@ExcelProperty(value="入职时项目组信息",index = 13)
	private String projectNameF;

	/**
	 * 访谈计划号
	 */
	@ExcelProperty(value="访谈计划号",index = 14)
	 ...
	 * 技能水平
	 */
	@ExcelProperty(value="技能水平",index = 15)
	private String skiLevel;

	/**
	 * 当前访谈进度
	 */
	@ExcelProperty(value="当前访谈进度",index = 16,converter = TalkplanColdConverter.class)
