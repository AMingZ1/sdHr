...
public class Tsder01Upload {
     ...
     * 面试部门
     */
    @ExcelProperty(value="部门",converter = DeptColdConverter.class)
    private String deptName;

    /**
     * 面试部门
     */
    @ExcelProperty(value="二级事业部",converter = DeptColdConverter.class)
    private String secondLevelDept;

    /**
     * 岗位
     */
    @ExcelProperty(value="岗位",converter = JobsColdConverter.class)
    private String jobs;
